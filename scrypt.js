...
const product1Datas = [
    {image: "images/products/jacket-1.jpg", image2: "images/products/clothes-1.jpg", marque: "dani alves jacket", name: "Jacket men's hiver", ratingFull: `<ion-icon name="star"></ion-icon>`, ratingOutline: `<ion-icon name="star-half"></ion-icon>`, price: "85", iconBuy: `<ion-icon name="bag-add-outline"></ion-icon>`},
    {image: "images/products/clothes-1.jpg", marque: "addidas", name: "Cartoon astronaut T-Shirts", ratingFull: `<ion-icon name="star"></ion-icon>`, ratingOutline: `<ion-icon name="star-half"></ion-icon>`, price: "85", iconBuy: `<ion-icon name="bag-add-outline"></ion-icon>`},
    {image: "images/products/belt.jpg", marque: "addidas", name: "Cartoon astronaut T-Shirts", ratingFull: `<ion-icon name="star"></ion-icon>`, ratingOutline: `<ion-icon name="star-half"></ion-icon>`, price: "85", iconBuy: `<ion-icon name="bag-add-outline"></ion-icon>`},
    {image: "images/products/watch-1.jpg", marque: "addidas", name: "Cartoon astronaut T-Shirts", ratingFull: `<ion-icon name="star"></ion-icon>`, ratingOutline: `<ion-icon name="star-half"></ion-icon>`, price: "85", iconBuy: `<ion-icon name="bag-add-outline"></ion-icon>`},
    {image: "images/products/sports-2.jpg", marque: "addidas", name: "Cartoon astronaut T-Shirts", ratingFull: `<ion-icon name="star"></ion-icon>`, ratingOutline: `<ion-icon name="star-half"></ion-icon>`, price: "85", iconBuy: `<ion-icon name="bag-add-outline"></ion-icon>`},
    {image: "images/products/jewellery-1.jpg", marque: "addidas", name: "Cartoon astronaut T-Shirts", ratingFull: `<ion-icon name="star"></ion-icon>`, ratingOutline: `<ion-icon name="star-half"></ion-icon>`, price: "85", iconBuy: `<ion-icon name="bag-add-outline"></ion-icon>`},
    {image: "images/products/shoe-1.jpg", marque: "addidas", name: "Cartoon astronaut T-Shirts", ratingFull: `<ion-icon name="star"></ion-icon>`, ratingOutline: `<ion-icon name="star-half"></ion-icon>`, price: "85", iconBuy: `<ion-icon name="bag-add-outline"></ion-icon>`},
    {image: "images/products/shorts-1.jpg", marque: "addidas", name: "Cartoon astronaut T-Shirts", ratingFull: `<ion-icon name="star"></ion-icon>`, ratingOutline: `<ion-icon name="star-half"></ion-icon>`, price: "85", iconBuy: `<ion-icon name="bag-add-outline"></ion-icon>`},
    {image: "images/products/sports-6.jpg", marque: "addidas", name: "Cartoon astronaut T-Shirts", ratingFull: `<ion-icon name="star"></ion-icon>`, ratingOutline: `<ion-icon name="star-half"></ion-icon>`, price: "85", iconBuy: `<ion-icon name="bag-add-outline"></ion-icon>`},
    {image: "images/products/shirt-1.jpg", marque: "addidas", name: "Cartoon astronaut T-Shirts", ratingFull: `<ion-icon name="star"></ion-icon>`, ratingOutline: `<ion-icon name="star-half"></ion-icon>`, price: "85", iconBuy: `<ion-icon name="bag-add-outline"></ion-icon>`},
]
